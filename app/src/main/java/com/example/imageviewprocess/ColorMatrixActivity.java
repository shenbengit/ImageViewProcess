...
import com.example.imageviewprocess.algorithm.SpecialColorMatrix;
import com.example.imageviewprocess.util.ImageUtil;
...
public class ColorMatrixActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    class ColorMatrixAdapter extends RecyclerView.Adapter<ColorMatrixViewHolder> {

        @Override
        public ColorMatrixViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(final ColorMatrixViewHolder holder, int position) {
    ...
    static class ColorMatrixViewHolder extends RecyclerView.ViewHolder {
